<template>
    <form>
        <div class="processes processes-add location-process-add md-layout">
            <div class="md-layout-item md-size-75 md-small-size-50 md-xsmall-size-100">
                <md-card>
                    <md-card-content>

                        <p v-if="location">{{ Translate('you.adding.process.location') }}: <b><router-link :to="'/locations/' + location.hashid">{{location.name}}</router-link></b></p>
