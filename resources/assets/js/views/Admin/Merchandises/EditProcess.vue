<template>
    <form>
        <div class="processes processes-edit merchandise-processes-edit  md-layout">
...
export default {
    ...
    methods: {
        saveProcess () {
            Vue.axios.put('processes/' + this.$route.params.processHashid + '?model=merchandise&processable=' + this.merchandise.hashid, this.process)
                .then((response) => {
                    this.setSnackbarText('Action updated successfully')
