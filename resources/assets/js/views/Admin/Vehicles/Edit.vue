...
export default {
    ...
    created() {
        ...
        Vue.axios.get('vehicles/' + this.$route.params.hashid).then((response) => {
    ...
    methods: {
        saveVehicle () {
            Vue.axios.put('vehicles/' + this.$route.params.hashid, this.vehicle)
                .then((response) => {
                    this.setSnackbarText('Vehicle updated successfully')
