<template>
    <form>
        <div class="packages packages-edit md-layout">
...
export default {
    ...
    created() {
        ...
        Vue.axios.get('packages/' + this.$route.params.hashid).then((response) => {
    ...
    methods: {
        savePackage () {
            Vue.axios.put('packages/' + this.$route.params.hashid, this.pack)
                .then((response) => {
                    this.setSnackbarText('Package updated successfully')
