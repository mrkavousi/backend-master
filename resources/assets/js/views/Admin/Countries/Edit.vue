<template>
    <form>
        <div class="countries countries-edit md-layout">
...
export default {
    ...
    created() {
        ...
        Vue.axios.get('countries/' + this.$route.params.hashid).then((response) => {
    ...
    methods: {
        saveCountry () {
            Vue.axios.put('countries/' + this.$route.params.hashid, this.country)
                .then((response) => {
                    this.setSnackbarText('Country updated successfully')
