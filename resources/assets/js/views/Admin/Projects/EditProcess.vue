...
export default {
    ...
    created() {
        ...
        this.setPageTitle(this.Translate('edit.process'))

        Vue.axios.get('processes/' + this.$route.params.processHashid).then((response) => {
            this.process = response.data
            if (!this.process.packages.length) {
    ...
    methods: {
        saveProcess () {
            Vue.axios.put('processes/' + this.$route.params.processHashid + '?model=project&processable=' + this.project.hashid, this.process)
                .then((response) => {
                    this.setSnackbarText('Process updated successfully')
