<template>
    <div>
        <md-table v-model="roles" md-sort="created_at" md-sort-order="desc" md-card md-fixed-header>
        <md-table-toolbar>
        ...
        <md-table-empty-state>
            <md-button class="md-primary md-raised" to="/roles/add">{{ Translate('add.new') }}</md-button>
        </md-table-empty-state>
        ...
        <md-table-row slot="md-table-row" slot-scope="{ item }">
            ...
            <md-table-cell :md-label="Translate('name')" md-sort-by="display_name">
                {{ item.display_name }}
            </md-table-cell>
            ...
            <md-table-cell md-label="">
                <md-button class="md-icon-button md-primary" :to="'/roles/' + item.hashid">
...
import { mapMutations } from 'vuex'
  ...
  export default {
    ...
    created() {
        this.setPageTitle(this.Translate('role'))
    ...
    methods: {
        searchOnTable () {
            this.roles = this.search(this.roles, this.search)
        },
